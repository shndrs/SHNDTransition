...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of SHNDTransition.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/sahandraeisi1994@gmail.com/SHNDTransition'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'sahandraeisi1994@gmail.com' => 'sahandraeisi@yahoo.com' }
  s.source           = { :git => 'https://github.com/sahandraeisi1994@gmail.com/SHNDTransition.git', :tag => s.version.to_s }
